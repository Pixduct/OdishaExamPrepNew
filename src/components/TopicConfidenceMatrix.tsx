...
export const TopicConfidenceMatrix: React.FC<TopicConfidenceMatrixProps> = ({
  ...
  return (
    <DynamicVectorCard glowColor="rgba(37, 99, 235, 0.12)" className="mb-4 sm:mb-8">
      <div className="p-3.5 sm:p-7 text-slate-900 dark:text-white rounded-2xl sm:rounded-[2.2rem] bg-white/90 lg:bg-white/80 dark:bg-gradient-to-br dark:from-slate-900 dark:via-indigo-950/40 dark:to-slate-900 backdrop-blur-xl border-none shadow-xl shadow-slate-900/10 space-y-3.5 sm:space-y-4 relative group">
