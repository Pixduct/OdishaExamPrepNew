...
- [x] YouTube Carousel 100% Full-Card Uncut Display: Removed `maskImage` / `WebkitMaskImage` alpha gradient overlay from `YouTubeCarousel.tsx` and added `px-10` track padding, ensuring all video cards, 3D borders, and titles render 100% sharp and fully unclipped without right-side fading (`src/components/YouTubeCarousel.tsx`)
