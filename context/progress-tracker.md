...
- [x] YouTube Carousel Calibrated Edge-Fade Mask Engine: Applied calibrated 36px `maskImage` / `WebkitMaskImage` alpha gradient to `YouTubeCarousel.tsx` track, ensuring middle cards stay 100% sharp while entering/exiting cards dissolve smoothly into the edge fade without hard 1px box clipping (`src/components/YouTubeCarousel.tsx`)
