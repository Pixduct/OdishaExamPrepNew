  ...
  return (
    <div className="relative w-full min-h-screen bg-[#F8FAFC] dark:bg-transparent overflow-x-hidden" style={{ isolation: 'isolate' }}>
      ...
      >
        ...
        <div className="cv-card-auto">
          <DynamicVectorCard glowColor="rgba(37, 99, 235, 0.15)">
            <div className="p-4 sm:p-8 bg-gradient-to-br from-white via-slate-50/95 to-brand-50/30 dark:bg-gradient-to-br dark:from-[#0B1528] dark:via-[#112240] dark:to-[#0B1528] border border-slate-200/80 dark:border-blue-500/30 shadow-xl shadow-slate-200/40 dark:shadow-2xl dark:shadow-slate-950/60 rounded-2xl sm:rounded-[2.5rem] relative overflow-hidden z-10">
